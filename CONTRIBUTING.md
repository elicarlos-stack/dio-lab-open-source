...
ou para realizar via SSH digite o comando `git clone` seguido da URL no exemplo do seu forl e digite a senha SSH, Por exemplo:

```bash
git clone git@github.com:digitalinnovationone/dio-lab-open-source.git
```
